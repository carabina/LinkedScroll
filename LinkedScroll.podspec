#
#  Be sure to run `pod spec lint LinkedScroll.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/heron-newland/LinkedScroll"
  ...
  s.source       = { :git => "https://github.com/heron-newland/LinkedScroll.git", :tag => "1.0.0" }
